...
ActiveRecord::Schema.define(:version => 20120908073359) do
  ...
  add_index "users_tweets", ["user_id", "tweet_id"], :name => "index_users_tweets_on_user_id_and_tweet_id", :unique => true
